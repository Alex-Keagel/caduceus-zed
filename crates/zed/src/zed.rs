...
pub fn initialize_workspace(app_state: Arc<AppState>, cx: &mut App) {
    ...
    cx.observe_new(move |workspace: &mut Workspace, window, cx| {
        ...
        // Caduceus: edit prediction button removed
        ...
        workspace.status_bar().update(cx, |status_bar, cx| {
            ...
            // Caduceus: edit_prediction_ui removed
...
fn initialize_panels(window: &mut Window, cx: &mut Context<Workspace>) -> Task<anyhow::Result<()>> {
    cx.spawn_in(window, async move |workspace_handle, cx| {
        ...
        // Caduceus: collab panel disabled (channel::init not called)
        // let channels_panel =
...
fn register_actions(
    ...
    workspace
        ...
        // Caduceus: collab panel disabled
        .register_action(
            |workspace: &mut Workspace,
...
fn open_about_window(cx: &mut App) {
    ...
    cx.open_window(
        WindowOptions {
            titlebar: Some(TitlebarOptions {
                title: Some("About Caduceus".into()),
                appears_transparent: true,
...
mod tests {
    ...
    fn init_test_with_state(
        ...
        cx.update(move |cx| {
            ...
            theme_settings::init(theme::LoadThemes::JustBase, cx);
            audio::init(cx);
            // Caduceus: disabled Zed online services (collab, calls, notifications)
